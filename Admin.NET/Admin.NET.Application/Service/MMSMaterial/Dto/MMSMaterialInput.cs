...
/// MMS_Material基础输入参数
/// </summary>
public class MMSMaterialBaseInput
{
    /// <summary>
    /// Id
    /// </summary>
...
/// <summary>
/// MMS_Material分页查询输入参数
/// </summary>
public class MMSMaterialInput : BasePageInput
{
    /// <summary>
    /// Id
    /// </summary>
...
/// MMS_Material增加输入参数
/// </summary>
public class AddMMSMaterialInput : MMSMaterialBaseInput
{
    public long? Id { get; set; }
}
...
/// MMS_Material增加输入参数
/// </summary>
public class AddOrUpdateMaterialInput : MMSMaterialBaseInput
{
    public long? Id { get; set; }
}
...
/// MMS_Material删除输入参数
/// </summary>
public class DeleteMMSMaterialInput : BaseIdInput
{
}
...
/// MMS_Material更新输入参数
/// </summary>
public class UpdateMMSMaterialInput : MMSMaterialBaseInput
{
}

/// <summary>
/// MMS_Material主键查询输入参数
/// </summary>
public class QueryByIdMMSMaterialInput : DeleteMMSMaterialInput
{
