...
{
    public class ImportExcelTemplateAdjustmentDefault : ImportExcelTemplateStrategy
    {
        ...
        static List<string> _tableNames = new List<string>() { "WMS_Adjustment", "WMS_AdjustmentDetail" };

        public ImportExcelTemplateAdjustmentDefault(
        ...
        //    .Where(a => a.TableName == "WMS_Adjustment" &&
        //      a.TenantId == TenantId &&
        //      a.IsImportColumn == 1
        //    )
        ...
        //   });
        //    var detail = _repTableColumns.AsQueryable().Where(a => a.TableName == "WMS_AdjustmentDetail" &&
        //      a.TenantId == TenantId &&
        //      a.IsImportColumn == 1
        //    )
        //   .Select(a => new TableColumns
