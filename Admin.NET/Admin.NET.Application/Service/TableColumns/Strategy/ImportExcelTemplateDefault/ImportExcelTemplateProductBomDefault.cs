...
{
    public class ImportExcelTemplateProductBomDefault : ImportExcelTemplateStrategy
    {
        ...
        static List<string> _tableNames = new List<string>() { "WMS_ProductBom" };


        public ImportExcelTemplateProductBomDefault(
