...
{
    public class ImportExcelTemplateProductDefault : ImportExcelTemplateStrategy
    {
        ...
        static List<string> _tableNames = new List<string>() { "WMS_Product" };


        public ImportExcelTemplateProductDefault(
