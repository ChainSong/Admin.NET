...
public class WMSASNCountQuantityService : IDynamicApiController, ITransient
{
    ...
    public WMSASNCountQuantityService(SqlSugarRepository<WMSASNCountQuantity> rep, SqlSugarRepository<WMSASN> repASN, SqlSugarRepository<WMSASNDetail> repASNDetail, SqlSugarRepository<WMSCustomer> repCustomer, SqlSugarRepository<CustomerUserMapping> repCustomerUser, SqlSugarRepository<WarehouseUserMapping> repWarehouseUser, SqlSugarRepository<TableColumns> repTableColumns, SqlSugarRepository<TableColumnsDetail> repTableColumnsDetail, UserManager userManager, SqlSugarRepository<SysWorkFlow> repWorkFlow, SqlSugarRepository<WMSReceipt> repReceipt, SqlSugarRepository<WMSReceiptDetail> repReceiptDetail, SqlSugarRepository<WMSProduct> repProduct)
    {
        _rep = rep;
        _repASN = repASN;
...
;
    ...
    public async Task<Response<OrderStatusDto>> Add(List<long> input)
    {
        ...
        //使用简单工厂定制化修改和新增的方法
        ASNCountQuantityInterface factory = ASNCountQuantityFactory.AddOrUpdate(0);
        //factory._db = _db;
