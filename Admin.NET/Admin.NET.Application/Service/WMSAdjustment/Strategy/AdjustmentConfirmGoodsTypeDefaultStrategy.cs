...
{
    public class AdjustmentConfirmGoodsTypeDefaultStrategy : IAdjustmentConfirmInterface
    {
        ...
        public AdjustmentConfirmGoodsTypeDefaultStrategy()
        {
        }
            ...
            AdjustmentData.ForEach(a =>
            {
                ...
                //{
                    response.Data.Add(new OrderStatusDto
                    {
                        ...
                        //StatusMsg = StatusCode.warning.ToString(),
                        Msg = a.AdjustmentStatus == (int)AdjustmentStatusEnum.完成 ? "订单评级变更成功" : "订单评级变更失败",
