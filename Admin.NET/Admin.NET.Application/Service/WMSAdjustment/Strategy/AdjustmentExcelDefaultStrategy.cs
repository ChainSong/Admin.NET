...
{
    public class AdjustmentExcelDefaultStrategy : IAdjustmentExcelInterface
    {
        //注入数据库实例
        ...
        public AdjustmentExcelDefaultStrategy(
        )
        {
        ...
        public Response<DataTable> Strategy(dynamic request)
        {
            ...
            var headerTableColumn = GetColumns("WMS_Adjustment");
            var detailTableColumn = GetColumns("WMS_AdjustmentDetail");
