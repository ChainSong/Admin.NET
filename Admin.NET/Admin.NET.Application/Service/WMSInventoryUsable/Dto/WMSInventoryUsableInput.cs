...
namespace Admin.NET.Application;
    ...
    /// WMSInventory基础输入参数
    /// </summary>
    public class WMSInventoryUsableBaseInput
    {
        /// <summary>
        /// ASNDetailId
        /// </summary>
    ...
    /// <summary>
    /// WMSInventory分页查询输入参数
    /// </summary>
    public class WMSInventoryUsableInput : BasePageInput
    {
        /// <summary>
        /// ASNDetailId
        /// </summary>
    ...
    /// WMSInventory增加输入参数
    /// </summary>
    public class AddWMSInventoryUsableInput : WMSInventoryUsableBaseInput
    {
    }
    ...
    /// WMSInventory删除输入参数
    /// </summary>
    public class DeleteWMSInventoryUsableInput : BaseIdInput
    {
    }
    ...
    /// WMSInventory更新输入参数
    /// </summary>
    public class UpdateWMSInventoryUsableInput : WMSInventoryUsableBaseInput
    {
        /// <summary>
        /// Id
        /// </summary>
    ...
    /// <summary>
    /// WMSInventory主键查询输入参数
    /// </summary>
    public class QueryByIdWMSInventoryUsableInput : DeleteWMSInventoryUsableInput
    {
