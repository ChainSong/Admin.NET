...
namespace Admin.NET.Application;
    ...
    /// WMSOrder基础输入参数
    /// </summary>
    public class WMSOrderBaseInput
    {
        /// <summary>
        /// PreOrderId
        /// </summary>
    ...
    /// WMSOrder分页查询输入参数
    /// </summary>
    public class WMSOrderInput : BasePageInput
    {
        /// <summary>
        /// PreOrderId
        /// </summary>
    ...
    /// WMSOrder删除输入参数
    /// </summary>
    public class DeleteWMSOrderInput : BaseIdInput
    {
    }
    ...
    /// WMSOrder更新输入参数
    /// </summary>
    public class UpdateWMSOrderInput : WMSOrderBaseInput
    {
        /// <summary>
        /// Id
        /// </summary>
    ...
    /// WMSOrder主键查询输入参数
    /// </summary>
    public class QueryByIdWMSOrderInput : DeleteWMSOrderInput
    {
