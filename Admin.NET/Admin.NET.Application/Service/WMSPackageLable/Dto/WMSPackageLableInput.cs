...
namespace Admin.NET.Application;
    ...
    /// <summary>
    /// WMSPackageLable基础输入参数
    /// </summary>
    public class WMSPackageLableBaseInput
    {
        /// <summary>
        /// OrderId
        /// </summary>
    ...
    /// <summary>
    /// WMSPackageLable分页查询输入参数
    /// </summary>
    public class WMSPackageLableInput : BasePageInput
    {
        /// <summary>
        /// OrderId
        /// </summary>
    ...
    /// <summary>
    /// WMSPackageLable增加输入参数
    /// </summary>
    public class AddWMSPackageLableInput : WMSPackageLableBaseInput
    {
    }

    /// <summary>
    /// WMSPackageLable删除输入参数
    /// </summary>
    public class DeleteWMSPackageLableInput : BaseIdInput
    {
    }

    /// <summary>
    /// WMSPackageLable更新输入参数
    /// </summary>
    public class UpdateWMSPackageLableInput : WMSPackageLableBaseInput
    {
        /// <summary>
        /// Id
        /// </summary>
    ...
    /// <summary>
    /// WMSPackageLable主键查询输入参数
    /// </summary>
    public class QueryByIdWMSPackageLableInput : DeleteWMSPackageLableInput
    {
