...
public class ASNReceiptDetailStrategy : IASNReceiptDetailRFInterface
{
    public SqlSugarRepository<WMSASNReceiptDetail> _repASNReceiptDetail { get; set; }
    ...
    public async Task<Response<List<WMSASNReceiptDetail>>> GetASNDetail(WMSASNReceiptDetail request) { 
      return null;
