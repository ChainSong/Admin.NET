...
namespace Admin.NET.Application;
    ...
    /// WMSReceipt基础输入参数
    /// </summary>
    public class WMSReceiptBaseInput
    {
        /// <summary>
        /// ASNId
        /// </summary>
    ...
    /// WMSReceipt分页查询输入参数
    /// </summary>
    public class WMSReceiptInput : BasePageInput
    {
        /// <summary>
        /// ASNId
        /// </summary>
        ...
        /// <summary>
         /// 预计收货日期范围
         /// </summary>
         public List<DateTime?> ReceiptTime { get; set; } 
        /// <summary>
        /// 1入库 5待上架 9上架  -1取消
        /// </summary>
    ...
    /// WMSReceipt增加输入参数
    /// </summary>
    public class AddWMSReceiptInput : WMSReceiptBaseInput
    {
    }
    ...
    /// WMSReceipt删除输入参数
    /// </summary>
    public class DeleteWMSReceiptInput : BaseIdInput
    {
    }
    ...
    /// WMSReceipt更新输入参数
    /// </summary>
    public class UpdateWMSReceiptInput : WMSReceiptBaseInput
    {
        /// <summary>
        /// Id
        /// </summary>
    ...
    /// WMSReceipt主键查询输入参数
    /// </summary>
    public class QueryByIdWMSReceiptInput : DeleteWMSReceiptInput
    {
