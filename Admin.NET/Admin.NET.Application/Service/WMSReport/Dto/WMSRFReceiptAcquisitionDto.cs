...
public class WMSRFReceiptAcquisitionInput: WMSRFReceiptAcquisition
{
}
/// <summary>
/// 入库SN导出
/// </summary>
public class WMSRFReceiptAcquisitionExport
{
    [ExporterHeader(displayName: "预入库单号")]
    public string ASNNumber { get; set; }
    [ExporterHeader(displayName: "入库单号")]
