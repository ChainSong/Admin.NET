 ...
 *
 * @export
 * @interface AdminResultListWmsOutboundOutput
 */
export interface AdminResultListWmsOutboundOutput {

    /**
     * 状态码
     *
     * @type {number}
     * @memberof AdminResultListWmsOutboundOutput
     */
    code?: number;
     ...
     * @memberof AdminResultListWmsOutboundOutput
     */
    result?: Array<WmsOutboundOutput> | null;
