...
enum Api {
	...
	AvailableInventorySummaryReportExport = '/api/wMSInventoryReport/AvailableInventorySummaryReportExport',
}
...
// 导出WMSInventoryReport
export const availableInventorySummaryReportExport = (params?: any) =>
	request({
		url: Api.AvailableInventorySummaryReportExport,
		method: 'post',
		data: params,
	});