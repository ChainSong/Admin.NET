  ...
  <div class="mMSInventoryUsable-container">
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'mMSInventoryUsable:page'"> 查询 </el-button>
          </el-button-group>
        </el-form-item>
        <!-- <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAdd" v-auth="'mMSInventoryUsable:add'"> 新增
          </el-button>
        </el-form-item> -->
      </el-form>
    </el-card>
...
<script lang="ts" setup="" name="mMSInventoryUsable">
import { ref, onMounted } from "vue";
import { ElMessageBox, ElMessage } from "element-plus";
import { auth } from '/@/utils/authFunction';
// import editDialog from '/@/views/main/mMSInventoryUsable/component/editDialog.vue'
// import addDialog from '/@/views/main/mMSInventoryUsable/component/addDialog.vue'
// import queryDialog from '/@/views/main/mMSInventoryUsable/component/queryDialog.vue'
import selectRemote from '/@/views/tools/select-remote.vue'

// import { pageWMSInventoryUsable, deleteWMSInventoryUsable } from '/@/api/main/mMSInventoryUsable';
import { pageMMSInventoryUsable, deleteMMSInventoryUsable } from '/@/api/main/mMSInventoryUsable';
import { getByTableNameList } from "/@/api/main/tableColumns";

import Header from "/@/entities/mInventoryUsable";
...
const gettableColumn = async () => {
  let res = await getByTableNameList("MMS_Inventory_Usable");
...
const handleQuery = async () => {
  loading.value = true; 
  var res = await pageMMSInventoryUsable(Object.assign(state.value.header, tableParams.value));
...
const del = (row: any) => {
  ElMessageBox.confirm(`确定要删除吗?`, "提示", {
    ...
    .then(async () => {
      await deleteWMSInventoryUsable(row);
      handleQuery();
