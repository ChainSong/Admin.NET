  ...
  <div class="mMSMaterial-container">
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'mMSMaterial:page'"> 查询 </el-button>
          </el-button-group>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAdd" v-auth="'mMSMaterial:add'"> 新增
          </el-button>
        </el-form-item>
      </el-form>
    </el-card>
...
<script lang="ts" setup="" name="mMSMaterial">
import { ref, onMounted } from "vue";
import { ElMessageBox, ElMessage } from "element-plus";
import { auth } from '/@/utils/authFunction';
import editDialog from '/@/views/main/mMSMaterial/component/editDialog.vue'
import addDialog from '/@/views/main/mMSMaterial/component/addDialog.vue'
import queryDialog from '/@/views/main/mMSMaterial/component/queryDialog.vue'
import selectRemote from '/@/views/tools/select-remote.vue'

// import { pageWMSProduct, deleteWMSProduct } from '/@/api/main/mMSMaterial';
import { pageMMSMaterial, deleteMMSMaterial } from '/@/api/main/mMSMaterial';
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageMMSMaterial(Object.assign(state.value.header, tableParams.value));
