<template>
  <div class="mMSReceipt-container">
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'mMSReceipt:page'"> 查询 </el-button>
            <!-- <el-button icon="ele-Refresh" @click="() => queryParams = {}"> 重置 </el-button> -->
          </el-button-group>

        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAdd" v-auth="'mMSReceipt:receipt'"> 新增
          </el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="ele-Upload" @click="exportReceipts" v-auth="'mMSReceipt:receipt'"> 导出入库信息
          </el-button>
        </el-form-item>
      
        <el-form-item>
          <el-button type="primary" icon="ele-Download" @click="exportReceiptReceivingfun"
            v-auth="'mMSReceipt:receiptReceiving'"> 导出上架信息
          </el-button>
        </el-form-item>
        <!-- <el-form-item>
          <el-button type="primary" icon="ele-Printer" @click="openPrint" v-auth="'mMSReceipt:Print'"> 打印
          </el-button>
        </el-form-item> -->
...
<script lang="ts" setup="" name="mMSReceipt">
import { ref, onMounted } from "vue";
import { ElMessageBox, ElMessage } from "element-plus";
import { auth } from '/@/utils/authFunction';
//import { formatDate } from '/@/utils/formatTime';

import editDialog from '/@/views/main/mMSReceipt/component/editDialog.vue'
import addDialog from '/@/views/main/mMSReceipt/component/addDialog.vue'
import queryDialog from '/@/views/main/mMSReceipt/component/queryDialog.vue'
import { pageMMSReceipt, deleteMMSReceipt, exportReceipt, exportReceiptReceiving } from '/@/api/main/mMSReceipt';
import { getByTableNameList } from "/@/api/main/tableColumns";
import printDialog from '/@/views/tools/printDialog.vue';
import selectRemote from '/@/views/tools/select-remote.vue'
import Header from "/@/entities/mMSreceipt";
import Details from "/@/entities/mMSreceiptDetail";
...
const gettableColumn = async () => {
  let res = await getByTableNameList("MMS_Receipt");
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageMMSReceipt(Object.assign(state.value.header, tableParams.value));
...
const del = (row: any) => {
  ElMessageBox.confirm(`确定要删除吗?`, "提示", {
    ...
    .then(async () => {
      let res = await deleteMMSReceipt(row);
