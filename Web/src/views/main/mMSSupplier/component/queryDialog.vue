...
import { addMMSSupplier, updateMMSSupplier, getMMSSupplier } from "/@/api/main/mMSSupplier";
import { getByTableNameList } from "/@/api/main/tableColumns";
import Header from "/@/entities/Supplier";
// import Detail from "/@/entities/customerDetail";
import TableColumns from "/@/entities/tableColumns";
// import { getMMSCustomer } from "/@/api/main/mMSCustomer";
...
// 				await updateMMSCustomer(values);
// 			} else {
// 				await addMMSCustomer(values);
// 			}
// 			closeDialog();
// 		} else {
// 			ElMessage({
...
const get = async () => {
	// console.log("dasdasd");
	// console.log(state.value.header);
	let result = await getMMSSupplier(state.value.header.id);
	// console.log(result);
