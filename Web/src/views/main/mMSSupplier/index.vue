<template>
  <div class="mMSSupplier-container">
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'mMSSupplier:page'"> 查询 </el-button>
            <!-- <el-button icon="ele-Refresh" @click="() => queryParams = {}"> 重置 </el-button> -->
          </el-button-group>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAdd" v-auth="'mMSSupplier:add'"> 新增
          </el-button>
        </el-form-item>
...
<script lang="ts" setup="" name="mMSSupplier">
import { ref, onMounted } from "vue";
import { ElMessageBox, ElMessage } from "element-plus";
import { auth } from '/@/utils/authFunction';
//import { formatDate } from '/@/utils/formatTime';

import editDialog from '/@/views/main/mMSSupplier/component/editDialog.vue'
import addDialog from '/@/views/main/mMSSupplier/component/addDialog.vue'
import queryDialog from '/@/views/main/mMSSupplier/component/queryDialog.vue'
import { pageMMSSupplier, deleteMMSSupplier } from '/@/api/main/mMSSupplier';
import { getByTableNameList } from "/@/api/main/tableColumns";

import Header from "/@/entities/supplier";
// import Details from "/@/entities/supplierDetail";
...
const gettableColumn = async () => {
  ...
  let res = await getByTableNameList("MMS_Supplier");
  state.value.tableColumnHeaders = res.data.result;
  // console.log(" state.value.tableColumnHeaders")
  // console.log(state.value.tableColumnHeaders)
  // console.log(state.value.header)
  // let resDetail = await getByTableNameList("SupplierDetail");
  // state.value.tableColumnHeaders = res.data.result;
...
const handleQuery = async () => {
  loading.value = true;
  var res = await pageMMSSupplier(Object.assign(state.value.header, tableParams.value));
