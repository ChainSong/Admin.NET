...
<script lang="ts" setup>
	...
	import { addSupplierUserMapping, updateSupplierUserMapping } from "/@/api/main/supplierUserMapping";
	//父级传递来的参数
  ...
  ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
    if (isValid) {
      ...
      if (ruleForm.value.id != undefined && ruleForm.value.id > 0) {
        await updateSupplierUserMapping(values);
      } else {
        await addSupplierUserMapping(values);
      }
      closeDialog();
    } else {
      ElMessage({
