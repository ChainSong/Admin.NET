...
import { addWMSASN, updateWMSASN } from "/@/api/main/wMSASN";
...
//给上传组件赋值url
let uploadURL = baseURL + '/api/wMSASN/UploadExcelFile';
//给上传组件赋值token
// 获取本地的 token
...
const exportExcel = async () => {
	// state.loading = true;
	var res = await getImportExcelTemplate({ CustomerId: state.value.header.customerId, TableName: "WMS_ASN" });
	// state.loading = false;
