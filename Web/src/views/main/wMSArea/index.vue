  ...
  <div class="wMSArea-container">
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'wMSArea:page'"> 查询 </el-button>
            <!-- <el-button icon="ele-Refresh" @click="() => queryParams = {}"> 重置 </el-button> -->
          </el-button-group>

        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAdd" v-auth="'wMSArea:add'"> 新增
          </el-button>
...
import editDialog from '/@/views/main/wMSArea/component/editDialog.vue'
import addDialog from '/@/views/main/wMSArea/component/addDialog.vue'
import queryDialog from '/@/views/main/wMSArea/component/queryDialog.vue'
import selectRemote from '/@/views/tools/select-remote.vue'

import { pageWMSWarehouse, deleteWMSWarehouse } from '/@/api/main/wMSWarehouse';
import { pageWMSArea, deleteWMSArea } from '/@/api/main/wMSArea';
