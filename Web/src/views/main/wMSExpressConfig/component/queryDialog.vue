...
import { pageWMSExpressConfig, deleteWMSExpressConfig,getWMSExpressConfig } from "/@/api/main/wMSExpressConfig";'/@/api/main/wMSExpressConfig';
...
const gettableColumn = async () => {
	...
	// 	}
	// });
	// let resDetail = await getByTableNameList("WMS_Area");
