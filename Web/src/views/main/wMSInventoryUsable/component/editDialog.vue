			...
			<el-form :model="ruleForm" ref="ruleFormRef" size="default" label-width="100px" :rules="rules">
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="ASNDetailId" prop="aSNDetailId">
							<el-input v-model="ruleForm.aSNDetailId" placeholder="请输入ASNDetailId" clearable />
							
						</el-form-item>
						
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="ReceiptDetailId" prop="receiptDetailId">
							<el-input v-model="ruleForm.receiptDetailId" placeholder="请输入ReceiptDetailId" clearable />
...
<script lang="ts" setup>
	...
	import { addWMSInventoryUsable, updateWMSInventoryUsable } from "/@/api/main/wMSInventoryUsable";
	//父级传递来的参数
  ...
  ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
    if (isValid) {
      ...
      if (ruleForm.value.id != undefined && ruleForm.value.id > 0) {
        await updateWMSInventoryUsable(values);
      } else {
        await addWMSInventoryUsable(values);
      }
      closeDialog();
    } else {
      ElMessage({
