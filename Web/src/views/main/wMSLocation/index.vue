<template>
  <div class="wMSLocation-container">
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'wMSLocation:page'"> 查询 </el-button>
          </el-button-group>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAdd" v-auth="'wMSLocation:add'"> 新增
          </el-button>
        </el-form-item>
      </el-form>
    </el-card>
...
<script lang="ts" setup="" name="wMSLocation">
import { ref, onMounted } from "vue";
import { ElMessageBox, ElMessage } from "element-plus";
import { auth } from '/@/utils/authFunction';
import editDialog from '/@/views/main/wMSLocation/component/editDialog.vue'
import addDialog from '/@/views/main/wMSLocation/component/addDialog.vue'
import queryDialog from '/@/views/main/wMSLocation/component/queryDialog.vue'
import selectRemote from '/@/views/tools/select-remote.vue'

// import { pageWMSLocation, deleteWMSLocation } from '/@/api/main/wMSLocation';
import { pageWMSLocation, deleteWMSLocation } from '/@/api/main/wMSLocation';
import { getByTableNameList } from "/@/api/main/tableColumns";

import Header from "/@/entities/Location";
// import Details from "/@/entities/LocationDetail";
...
const handleQuery = async () => {
  ...
  var res = await pageWMSLocation(Object.assign(state.value.header, tableParams.value));
