    ...
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        <el-form-item label="菜单名称">
          <el-input v-model="queryParams.menuName" clearable="" placeholder="请输入名称"/>
          
        </el-form-item>
        <!-- <el-form-item label="UICode">
          <el-input v-model="queryParams.uICode" clearable="" placeholder="请输入UICode"/>
        </el-form-item> -->
        <!-- <el-form-item label="UIType">
          <el-input v-model="queryParams.uIType" clearable="" placeholder="请输入UIType"/>
        </el-form-item> -->
        <!-- <el-form-item label="DataSource">
          <el-input v-model="queryParams.dataSource" clearable="" placeholder="请输入DataSource"/>
        </el-form-item> -->
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary"  icon="ele-Search" @click="handleQuery" v-auth="'wMSLowCode:page'"> 查询 </el-button>
            <el-button icon="ele-Refresh" @click="() => queryParams = {}"> 重置 </el-button>
          </el-button-group>
          
        </el-form-item>
        <!-- <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="openAddWMSLowCode" v-auth="'wMSLowCode:add'"> 新增 </el-button>
        </el-form-item> -->
