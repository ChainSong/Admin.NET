  ...
  <div class="wMSPreOrder-container">
    <el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
      <el-form :model="queryParams" ref="queryForm" :inline="true">
        ...
        <el-form-item>
          <el-button-group>
            <el-button type="primary" icon="ele-Search" @click="handleQuery" v-auth="'wMSPreOrder:page'"> 查询 </el-button>
        ...
        <el-form-item>
          <el-button type="primary" icon="ele-Plus" @click="PreOrderForOrderFun" v-auth="'wMSPreOrder:add'"> 转出库单
          </el-button>
        </el-form-item>
...
const handleSizeChange = (val: number) => {
  ...
  console.log(tableParams.value.pageSize )
