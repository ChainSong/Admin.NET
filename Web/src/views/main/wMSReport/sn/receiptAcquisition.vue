    ...
    <div class="common-layout">
                ...
                <el-row :gutter="10" :span="24">
                    ...
                    <el-col :xs="12" :sm="6" :md="6" :lg="6" :xl="6">
                        <el-form-item label="入库单号">
                            <el-input v-model="formData.receiptNumber" placeholder="请输入出库单号" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="12" :sm="6" :md="6" :lg="6" :xl="6">
                        <el-form-item label="外部单号">
                            <el-input v-model="formData.externReceiptNumber" placeholder="请输入外部单号" clearable />
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="10" :span="24">
                    <el-col :xs="12" :sm="6" :md="6" :lg="6" :xl="6">
                        <el-form-item label="预入库单号">
                            <el-input v-model="formData.asnNumber" placeholder="请输入预出库单号" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="12" :sm="6" :md="6" :lg="6" :xl="6">
        ...
        <el-card class="full-table" shadow="hover" style="margin-top: 8px">
            <el-table :data="tableData" style="width: 100%" v-loading="loading" tooltip-effect="light">
                <el-table-column prop="asnNumber" label="预入库单号" width="180" align="center"/>
                <el-table-column prop="receiptNumber" label="入库单号" show-overflow-tooltip="" width="180"  align="center"/>
                <el-table-column prop="externReceiptNumber" label="出库单号" show-overflow-tooltip=""  width="180"  align="center"/>
                <el-table-column prop="customerName" label="客户名称" show-overflow-tooltip="" width="80"  align="center"/>
                <el-table-column prop="warehouseName" label="仓库名称" show-overflow-tooltip=""  align="center"/>
                <el-table-column prop="type" label="类型" show-overflow-tooltip=""  align="center"/>
                <el-table-column prop="sku" label="SKU" show-overflow-tooltip=""  align="center"/>
                <el-table-column prop="lot" label="Lot号" show-overflow-tooltip=""  align="center"/>
                ...
                <el-table-column prop="creator" label="创建用户" show-overflow-tooltip="" />
                <el-table-column prop="creationTime" label="创建时间" show-overflow-tooltip="" width="180"  align="center"/>
                <el-table-column prop="updator" label="修改用户" show-overflow-tooltip=""  align="center" />
...
import { getReceiptSNPageList, exportReceiptSN } from '/@/api/main/wMSReport';
...
const handleQuery = async () => {
    ...
    try {
        ...
        const res = await getReceiptSNPageList(reqParams);
...
const handleExport = async () => {
    try {
        loading.value = true;
        const reqParams = Object.assign({}, formData.value, tableParams.value);
        const res = await exportReceiptSN(reqParams);
